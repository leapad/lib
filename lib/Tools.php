...
class Tools{
     ...
     * Tools::exportExcel(array('姓名','年龄'), array(array('a',21),array('b',23)), '档案', './', true);
     */
    public static function exportExcel($title = array(), $data = array(), $fileName = '', $savePath = './', $isDown = false)
    {

        require Yii::getAlias('@common') . '/libs/PHPExcel.php';
        require Yii::getAlias('@common') . '/libs/PHPExcel/IOFactory.php';
     ...
     * @throws PHPExcel_Reader_Exception
     */
    public static function importExecl($file = '', $sheet = 0)
    {
        $file = iconv("utf-8", "gb2312", $file);   //转码
        if (empty($file) OR !file_exists($file)) {
            die('file not exists!');
        }
        require Yii::getAlias('@common') . '/libs/PHPExcel/Reader/Excel2007.php';
        require Yii::getAlias('@common') . '/libs/PHPExcel/Reader/Excel5.php';
     ...
     * @param bool $absolute
     * @return bool|string
     * 重新生成url, 在原有URL基础上新增参数
     */
    public static function createUrl($newParams = [], $absolute = false)
    {
        if (empty($newParams)) {
            return false;
        }
